...
# cs112-S2018-lab4-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 4 in Computer Science 112. Since
...
`InsertionSort.java` and `TestInsertionSort.java` files must adhere to all of
...
For instance, GatorGrader will check to ensure that `InsertionSort` has
`println` statements that produce exactly four lines of output.
GatorGrader will also check that your program performs the correct sorting of
...
page 111. Please see the course instructor or one of the teaching assistants or
...
output for the instructor's version of `InsertionSort`. Please note that this
laboratory assignment also invites you to implement a comprehensive JUnit test
suite in the class called `TestInsertionSort`. While this test suite does not
produce any output, you should carefully inspect the arrays that it generates so
that you understand their contents and, therefore, the strategy adopted by each
test.
...
- `InsertionSort.java` contains at least three multi-line comments in the
  JavaDoc standard.
- `InsertionSort.java` contains four `println`s to produce the four lines
  of output.
- `InsertionSort.java` correctly uses an enhancement of the book's method
  to sort an array.
- `TestInsertionSort.java` contains at least twelve complete and passing test cases.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-112-S2018/cs112-S2018-lab4-starter.git
```
...
you can go to the [Computer Science 112 Lab 4
Starter](https://github.com/Allegheny-Computer-Science-112-S2018/cs112-S2018-lab4-starter)
