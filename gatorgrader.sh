...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour/ \
                                     --checkfiles InsertionSort.java --multicomments 3 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 4 "println()" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/labfour \
                                     --checkfiles InsertionSort.java --fragments "println(" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 4 "private" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/test/java/labfour \
                                     --checkfiles TestInsertionSort.java --fragments "private" --fragmentcounts 4
  determine_exit_code $?
  # --> GatorGrader CHECK: at least 3 "@Test" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/test/java/labfour \
                                     --checkfiles TestInsertionSort.java --fragments "@Test" --fragmentcounts 12
  determine_exit_code $?
